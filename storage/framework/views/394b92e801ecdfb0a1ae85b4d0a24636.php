...
<title><?php echo $__env->yieldContent('title','Dashboard'); ?> — Supply Chain Risk Platform</title>
...
<nav class="sidebar" id="sidebar">
  ...
  <a href="<?php echo e(route('countries.index')); ?>" class="nav-link <?php echo e(request()->routeIs('countries.*') ? 'active' : ''); ?>">
    <i class="bi bi-globe"></i> Country Dashboard
  </a>
  <a href="<?php echo e(route('weather.index')); ?>" class="nav-link <?php echo e(request()->routeIs('weather.*') ? 'active' : ''); ?>">
    <i class="bi bi-cloud-sun"></i> Weather Monitoring
  </a>
  <a href="<?php echo e(route('currency.index')); ?>" class="nav-link <?php echo e(request()->routeIs('currency.*') ? 'active' : ''); ?>">
  ...
  <a href="<?php echo e(route('ports.index')); ?>" class="nav-link <?php echo e(request()->routeIs('ports.*') ? 'active' : ''); ?>">
    <i class="bi bi-anchor"></i> Port Locations
  </a>
  <a href="<?php echo e(route('comparison.index')); ?>" class="nav-link <?php echo e(request()->routeIs('comparison.*') ? 'active' : ''); ?>">
    <i class="bi bi-bar-chart-steps"></i> Country Comparison
  </a>
  <a href="<?php echo e(route('visualization.index')); ?>" class="nav-link <?php echo e(request()->routeIs('visualization.*') ? 'active' : ''); ?>">
    <i class="bi bi-graph-up"></i> Data Visualization
  </a>

  <div class="nav-section mt-2">Personal</div>
  <a href="<?php echo e(route('watchlist.index')); ?>" class="nav-link <?php echo e(request()->routeIs('watchlist.*') ? 'active' : ''); ?>">
    <i class="bi bi-star"></i> Watchlist
  </a>

  <?php if(auth()->user()?->isAdmin()): ?>
  <div class="nav-section mt-2">Admin</div>
  <a href="<?php echo e(route('admin.dashboard')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.*') ? 'active' : ''); ?>">
  ...
  <div class="mt-auto" style="padding:20px;border-top:1px solid rgba(255,255,255,.1);margin-top:20px">
    <div class="d-flex align-items-center gap-2">
      <img src="<?php echo e(auth()->user()?->avatar_url); ?>" width="34" height="34" class="rounded-circle" alt="avatar">
      <div>
        <div style="font-size:.82rem;font-weight:600;color:#fff"><?php echo e(auth()->user()?->name); ?></div>
        <div style="font-size:.7rem;color:#888"><?php echo e(ucfirst(auth()->user()?->role)); ?></div>
      </div>
    </div>
...
<div class="main-content">
  ...
  <div style="padding:0 24px">
    <?php $__currentLoopData = ['success'=>'success','error'=>'danger','warning'=>'warning','info'=>'info']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type => $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <?php if(session($type)): ?>
        <div class="alert alert-<?php echo e($class); ?> alert-dismissible fade show mt-3 mb-0" role="alert">
...
<?php /**PATH D:\Global Supply\supply-chain-platform\resources\views/layouts/app.blade.php ENDPATH**/ ?>